...
module.exports = {
    ...
    async execute(client, message, args, profileData) {
        ...
        const fetchUser = async (sortedTab, i) => client.users.fetch(sortedTab[i].id);
        fillTab = new Array();
        for (i = 0; i < 10; i++) {
        ...
        const leaderboardEmbed = new MessageEmbed()
            .setColor('#F8F70E')
            .setAuthor({ name: `Leaderboard Global des ChocoCoins:`, iconURL: `https://cdn.discordapp.com/avatars/${message.author.id}/${message.author.avatar}.jpeg` })
